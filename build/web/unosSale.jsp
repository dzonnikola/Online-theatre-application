<%-- 
    Document   : unosSale
    Created on : Sep 7, 2020, 11:20:53 AM
    Author     : Korisnik
--%>
...
<html>
    <head>
        ...
        <title>Unos nove sale - Manager Dashboard</title>
...
<body>
    <div style="margin-top:120px;" class="form-group">
        <center>
            <form id="forma" action="Sala" method="post">
                <h2 style="color:black;">Unos nove sale</h2>
                <table>
                    <tr>
                        <td>Broj sale</td><br>
